...
//           <div className=" flex flex-wrap">
//             <div className="w-full ">
//               <div className="mx-auto max-w-full rounded-3xl bg-gradient-to-br from-pink-400 to-sky-200 p-6 px-10 dark:bg-gradient-to-br dark:from-pink-700 dark:to-sky-500/30 sm:max-w-[800px] sm:p-[60px]">
//                 <h3 className="mb-3 text-center text-lg font-bold text-black dark:text-white sm:text-2xl md:text-3xl">
//                   Welcome. <br />
//                   <span className="text-base sm:text-xl">
//                     We exist to make learning easier.
...
//   const [message, setMessage] = useState("");
//   const [Work Authorization, setWork Authorization] = useState("");
...
//               <div className="mx-auto max-w-full rounded-3xl bg-gradient-to-br from-pink-400 to-sky-200 p-4 px-6 dark:bg-gradient-to-br dark:from-pink-700 dark:to-sky-500/30 sm:max-w-[700px] sm:pt-8 sm:pb-10 sm:px-10">
...
//                 </h3> */}
//                 {/* <p className="md:text-md mb-7 text-center text-xs font-semibold text-gray-700 dark:text-white sm:mb-11 sm:text-sm"> */}
//                 {/* <p className="md:text-lg mb-7 text-center text-base font-semibold text-gray-700 dark:text-white sm:mb-11 sm:text-lg">
//                   Create your account
//                 </p> */}
...
//                             />
//                             <path
//                               d="M10.2042 20.0001C12.9592 20.0001 15.2721 19.1111 16.9616 17.5778L13.7416 15.1332C12.88 15.7223 11.7235 16.1334 10.2042 16.1334C8.91385 16.126 7.65863 15.7206 6.61663 14.9747C5.57464 14.2287 4.79879 13.1802 4.39915 11.9778L4.27957 11.9878L1.12973 14.3766L1.08852 14.4888C1.93689 16.1457 3.23879 17.5387 4.84869 18.512C6.45859 19.4852 8.31301 20.0005 10.2046 20.0001"
//                               fill="#34A853"
//                             />
//                             <path
//                               d="M4.39911 11.9777C4.17592 11.3411 4.06075 10.673 4.05819 9.99996C4.0623 9.32799 4.17322 8.66075 4.38696 8.02225L4.38127 7.88968L1.19282 5.4624L1.08852 5.51101C0.372885 6.90343 0.00012207 8.4408 0.00012207 9.99987C0.00012207 11.5589 0.372885 13.0963 1.08852 14.4887L4.39911 11.9777Z"
...
//                   <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
//                     <div className="mb-6 sm:mb-8 flex-1">
//                       <label htmlFor="Work Authorization" className="mb-3 block font-bold text-dark dark:text-white">
...
//                         onChange={(e) => setWork Authorization(e.target.value)}
//                         onFocus={handleInputFocus}
//                         required
//                       >
